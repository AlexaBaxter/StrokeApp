...
public class ObjectIdentifierActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        picture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (PermissionChecker.checkSelfPermission(getApplicationContext(),Manifest.permission.CAMERA) == PermissionChecker.PERMISSION_GRANTED) {
    ...
    {/*
        try {
            ...
            String[] classes = {"Pen", "Phone", "Orange", "Sunscreen"};
